...
<head>
    ...
    <body>
        ...
        <script type="text/x-handlebars" data-template-name="packages/search">
        ...
        <script type="text/x-handlebars" data-template-name="packages/view">
            <h1>{{id}} {{version}}</h1>
